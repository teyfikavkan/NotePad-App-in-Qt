...
public:
    ...
    void setupUi(QDialog *SignIn)
    {
        ...
        lineNickname->setGeometry(QRect(57, 139, 133, 20));
        labelName = new QLabel(groupBox);
        labelName->setObjectName(QStringLiteral("labelName"));
        labelName->setGeometry(QRect(25, 17, 27, 16));
        lineSurname = new QLineEdit(groupBox);
        lineSurname->setObjectName(QStringLiteral("lineSurname"));
        lineSurname->setGeometry(QRect(254, 17, 133, 20));
        ...
        labelSurname->setGeometry(QRect(204, 17, 42, 16));
        ...
        lineName->setGeometry(QRect(57, 17, 133, 20));
        ...
        layoutWidget->setGeometry(QRect(121, 200, 239, 34));
