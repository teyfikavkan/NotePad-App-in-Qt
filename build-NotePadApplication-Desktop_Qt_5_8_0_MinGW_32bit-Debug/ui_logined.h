...
public:
    ...
    QComboBox *comboBoxSearchOpen;
    QPushButton *pushOpenSearchedBttn;
    QTableWidget *tableWidget;
    QComboBox *comboBoxSearchDelete;
    QPushButton *pushDeleteSearchedBttn;
    QWidget *tab_7;
    QTableView *tableViewDate;
    QPushButton *pushShowDatesBttn;
    ...
    void setupUi(QDialog *Logined)
    {
        ...
        textNote->setGeometry(QRect(10, 52, 411, 201));
        layoutWidget1 = new QWidget(tab_6);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(10, 11, 411, 24));
        ...
        labelDate = new QLabel(layoutWidget1);
        ...
        pushSearchBttn->setGeometry(QRect(335, 41, 91, 23));
        lineEditSearch = new QLineEdit(tab_8);
        lineEditSearch->setObjectName(QStringLiteral("lineEditSearch"));
        lineEditSearch->setGeometry(QRect(335, 11, 91, 23));
        comboBoxSearchOpen = new QComboBox(tab_8);
        comboBoxSearchOpen->setObjectName(QStringLiteral("comboBoxSearchOpen"));
        comboBoxSearchOpen->setGeometry(QRect(335, 117, 91, 23));
        pushOpenSearchedBttn = new QPushButton(tab_8);
        pushOpenSearchedBttn->setObjectName(QStringLiteral("pushOpenSearchedBttn"));
        pushOpenSearchedBttn->setGeometry(QRect(335, 151, 91, 23));
        ...
        comboBoxSearchDelete = new QComboBox(tab_8);
        comboBoxSearchDelete->setObjectName(QStringLiteral("comboBoxSearchDelete"));
        comboBoxSearchDelete->setGeometry(QRect(335, 214, 91, 23));
        pushDeleteSearchedBttn = new QPushButton(tab_8);
        pushDeleteSearchedBttn->setObjectName(QStringLiteral("pushDeleteSearchedBttn"));
        pushDeleteSearchedBttn->setGeometry(QRect(335, 249, 91, 23));
        tabWidget_3->addTab(tab_8, QString());
        tabWidget->addTab(tab_2, QString());
        tab_7 = new QWidget();
        tab_7->setObjectName(QStringLiteral("tab_7"));
        tableViewDate = new QTableView(tab_7);
        tableViewDate->setObjectName(QStringLiteral("tableViewDate"));
        tableViewDate->setGeometry(QRect(10, 10, 311, 291));
        pushShowDatesBttn = new QPushButton(tab_7);
        pushShowDatesBttn->setObjectName(QStringLiteral("pushShowDatesBttn"));
        pushShowDatesBttn->setGeometry(QRect(330, 130, 91, 23));
    ...
    void retranslateUi(QDialog *Logined)
    {
        ...
        labelDate->setText(QApplication::translate("Logined", "Date:", Q_NULLPTR));
        ...
        pushDeleteSearchedBttn->setText(QApplication::translate("Logined", "Delete", Q_NULLPTR));
        ...
        pushShowDatesBttn->setText(QApplication::translate("Logined", "Show Dates", Q_NULLPTR));
